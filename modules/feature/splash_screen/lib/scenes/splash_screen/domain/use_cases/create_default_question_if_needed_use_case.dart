...
class DefaultCreateDefaultQuestionsIfNeededUseCase
  ...
  execute() async {
    ...
    defaultQuestions.forEach((element) async {
      await _repository.createQuestion(element);
    });
  }
}
